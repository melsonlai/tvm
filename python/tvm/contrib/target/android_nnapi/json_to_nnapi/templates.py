...
declare_operand = string.Template("""JSON2NNAPI_CHECK_EQ(
...
declare_constant = {
        "scalar": string.Template("""static ${dtype} ${name} = ${value};
"""), 
        "array": string.Template("""static ${dtype} ${name}[${length}] = ${value};
"""), 
        }
...
initialize_operand = {
        "memory_ptr": string.Template("""JSON2NNAPI_CHECK_EQ(
...
"""), 
        "ann_memory": string.Template("""JSON2NNAPI_CHECK_EQ(
...
set_execution_input = string.Template("""JSON2NNAPI_CHECK_EQ(
...
set_execution_output = string.Template("""JSON2NNAPI_CHECK_EQ(
